// Generated by python test-mulN.py 768
...
extern void gf_polymul_768x768_divR(int *h, int *f, int *g);
...
int main (void) {
  ...
  for (i=0; i< NUMTESTS + WARMCACHE ; i++) { 
    ...
    time1  = cpucycles();
    gf_polymul_768x768_divR(hh,ff,gg);
    time2  = cpucycles();    

#if _NO_DEBUG_ != 1
    printf("h=GF4591x(");
    print16n((short *)hh,96);
    printf(")\n");
#endif
