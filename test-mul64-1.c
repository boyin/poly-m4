...
int main (void) {
  ...
  for (i=0; i< NUMTESTS + WARMCACHE ; i++) { 
    ...
    rand16(f); rand16(f+16); rand16(f+32); rand16(f+48);
    rand16_1(g); rand16_1(g+16); rand16_1(g+32); rand16_1(g+48);
